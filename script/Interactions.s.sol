...
contract MintBasicNft is Script {
    ...
    function mintNftOnContract(address contractAddress) public {
        ...
        /* Just getting the BasicNft that is already deployed on this address.
        Solidity allows you to interact with an existing deployed contract by using its address and the contract's ABI (Application Binary Interface).
        BasicNft(contactAddress) tells Solidity to treat contactAddress as an instance of the BasicNft contract.
        */
